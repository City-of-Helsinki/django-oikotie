...
from django_oikotie.enums import (ApartmentAction, ApartmentType,
                                  BuildingRightAmountType, EstateType,
                                  GeneralConditionLevel, LivingAreaType,
                                  ModeOfHabitationRentType,
                                  ModeOfHabitationType,
                                  NewDevelopmentStatusChoices,
                                  ParkingSpaceHeatingType, ParkingSpaceType,
                                  ShoreType, SiteType)
from django_oikotie.xml_models.apartment import (Apartment, Attachments,
                                                 Balcony, BuildingRightsAmount,
                                                 CableTvCharge, CampaignLink,
                                                 CarParkingCharge, ChargeFee,
                                                 City, CityPlanPicture,
                                                 DebtPayable,
                                                 ElectricityConsumptionCharge,
                                                 Estate, EstateAgentRating,
                                                 EstateAgentSocialMedia,
                                                 FinancingFee, FinancingOffer1,
                                                 FinancingOffer2, FloorArea,
                                                 FloorLocation,
                                                 GeneralCondition,
                                                 HeatingCosts,
                                                 HousingCompanyFee, Lift,
                                                 LivingArea, MaintenanceFee,
                                                 ModeOfHabitation,
                                                 NewDevelopmentStatus,
                                                 OnlineOfferLabel,
                                                 ParkingSpace, Picture,
                                                 PictureDescription,
                                                 PromotionalOffer,
                                                 RedemptionPrice,
                                                 RentComission, Rented,
                                                 RentFixedTerm, RentFurnished,
                                                 RentPerDay, RentPerMonth,
                                                 RentPerWeek, RentPerWeekEnd,
                                                 RentPerYear,
                                                 RentSecurityDeposit2,
                                                 SalesPrice, Sauna,
                                                 SaunaCharge, Shore,
                                                 ShowingDate1, Site, SiteArea,
                                                 TotalArea,
                                                 UnencumberedSalesPrice,
                                                 WaterFee, YearOfBuilding)
...
class ApartmentFactory(factory.Factory):
    ...
    other_post_code = fuzzy.FuzzyText(length=6)
    ...
    renovation_year_facade = fuzzy.FuzzyText(length=9)
    renovation_year_roof = fuzzy.FuzzyText(length=9)
    renovation_year_plumbing = fuzzy.FuzzyText(length=9)
    renovation_year_bathrooms = fuzzy.FuzzyText(length=9)
    future_renovations = fuzzy.FuzzyText()
    future_renovation_year_facade = fuzzy.FuzzyText(length=9)
    future_renovation_year_roof = fuzzy.FuzzyText(length=9)
    future_renovation_year_plumbing = fuzzy.FuzzyText(length=9)
    future_renovation_year_bathrooms = fuzzy.FuzzyText(length=9)
