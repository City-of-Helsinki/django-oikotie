...
from .factories.apartment import (
    ...
    AttachmentsFactory,
    BalconyFactory,
    BuildingRightsAmountFactory,
    CableTvChargeFactory,
    CampaignLinkFactory,
    CarParkingChargeFactory,
    ChargeFeeFactory,
    CityFactory,
    ...
    EstateFactory,
    FinancingFeeFactory,
    FinancingOffer1Factory,
    FinancingOffer2Factory,
    FloorAreaFactory,
    FloorLocationFactory,
    GeneralConditionFactory,
    HeatingCostsFactory,
    HousingCompanyFeeFactory,
    LiftFactory,
    LivingAreaFactory,
    MaintenanceFeeFactory,
    MinimalApartmentFactory,
    ModeOfHabitationFactory,
    NewDevelopmentStatusFactory,
    OnlineOfferLabelFactory,
    ParkingSpaceFactory,
    PictureDescriptionFactory,
    PictureFactory,
    PromotionalOfferFactory,
    RedemptionPriceFactory,
    RentComissionFactory,
    RentedFactory,
    RentFixedTermFactory,
    RentFurnishedFactory,
    RentPerDayFactory,
    RentPerMonthFactory,
    RentPerWeekEndFactory,
    RentPerWeekFactory,
    RentPerYearFactory,
...
def test_appartment_xml_created(test_folder):
    ...
    test_folder, test_file = create_apartments(apartment, test_folder)
